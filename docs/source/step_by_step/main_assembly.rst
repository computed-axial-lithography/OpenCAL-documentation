...
#. NOTE: Complete the :ref:`Camera Wiring section <camera-wiring>` first. Install the **Camera Mount** in the position below. Position it around ~113.6 mm from the bottom of the 3D print to the top of the bottom rail. Tighten the M5 Fasteners.
...
#. Part 1 of the Main Assembly Process is complete. 
   **IMPORTANT:** Complete all remaining :ref:`Wiring Instructions <wiring-instructions>` before moving on to Part 2.
